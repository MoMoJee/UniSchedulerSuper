...
def get_available_tools(request):
    ...
    tool_display_names = {
        ...
        # 12306 火车票查询
        "query-tickets": "车次余票查询",
        "query-ticket-price": "查询票价信息",
        "search-stations": "车站搜索",
        "query-transfer": "换乘方案查询",
        "get-train-route-stations": "列车经停站查询",
        "get-train-no-by-train-code": "车次号转换",
        ...
        "maps_schema_navi": "导航地图",
        "maps_schema_take_taxi": "打车地图",
        "maps_weather": "天气查询",
        # 旧格式地图工具（保留兼容性）
